...
export default function Footer() {
  return (
    <footer className="bg-[#183EC2] relative text-white pt-16 pb-3">
      <Image
      ...
      <div className=" max-w-5xl relative z-10 mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <nav className="flex flex-col gap-2">
              <Link href="/about-us" className="text-sm hover:text-yellow-400">
                About Us
              </Link>
              <Link
                href="/our-portfolio"
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <nav className="flex flex-col gap-2">
              <Link
                href="/logo-brand-packaging-design"
                className="text-sm hover:text-yellow-400"
              >
                Logo, Brand, Packaging Design
              </Link>
              <Link
                href="/digital-print-design"
                className="text-sm hover:text-yellow-400"
              >
                Digital and Print Design
              </Link>
              <Link
                href="/retail-office-branding"
                className="text-sm hover:text-yellow-400"
              >
                Retail, Office Space Branding
              </Link>
            </nav>
          </div>
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex gap-4 mt-4">
              <a
                href="https://www.instagram.com/Communik_ce/"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/aarti-k-communik/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
              >
